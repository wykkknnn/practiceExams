---
name: practice-exams
description: Generate ethical practice exam papers, answer keys, marking rubrics, and revision diagnostics from lecture slides, notes, readings, labs, assignments, past quizzes, or other course materials. Use when a student, tutor, instructor, or study group wants sample exams, mock tests, topic-balanced question sets, exam-style practice, worked solutions, grading criteria, or study plans based on provided learning materials while avoiding reproduction of real unreleased exam content.
---
...
3. Choose an exam blueprint.
   - If the user supplied a format, mirror it.
